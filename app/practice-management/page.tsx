...
const LINKS = [
  {
    title: "Level Wise",
    description: "Create level-wise practice by choosing exam, subject, unit, chapter, topic, subtopic, or definition.",
    href: "/practice-management/level-wise",
    icon: Layers,
  },
  {
    title: "Full Length",
    description: "Create full-length mock tests for an exam (complete paper in one go).",
    href: "/practice-management/full-length",
    icon: FileQuestion,
  },
  {
    title: "Previous Years Paper",
    description: "Manage previous year exam papers.",
  ...
  return (
    <div className="flex min-h-0 flex-1 min-w-0 flex-col">
      ...
      <div className="min-h-0 min-w-0 flex-1 space-y-6 overflow-auto p-6">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Practice Management</h1>
          <p className="text-muted-foreground mt-1">
            Choose how you want to manage practice content: level-wise tests, full-length mocks, or previous year papers.
          </p>
        </div>
