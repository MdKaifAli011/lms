...
import { ArrowRight, Search, Clock, BarChart, ChevronDown, Lock, Smartphone } from 'lucide-react'
...
export default function MockTestHub() {
  return (
    <main className="max-w-7xl mx-auto w-full min-w-0 px-3 min-[480px]:px-4 sm:px-5 md:px-6 py-10 sm:py-12 md:py-14 selection:bg-primary/30">
        {/* Section header – same pattern as home/exam */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 sm:mb-10">
          <div>
            ...
            <p className="mt-2 sm:mt-3 text-sm sm:text-base text-muted-foreground max-w-xl">
              Choose from our AI-curated list of mock tests designed to simulate real exam environments and difficulty levels.
            </p>
          </div>
                ...
                <div className="relative z-10 grid md:grid-cols-2 gap-6 sm:gap-8 p-6 sm:p-8 md:p-10">
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-muted-foreground mb-6 sm:mb-8 leading-relaxed">
                      Based on your previous performance in Biology and Physics, this test is calibrated to bridge your current score gaps. Includes real-time AI invigilation.
                    </p>
                  ...
                  <div className="hidden md:block relative">
                    ...
                    <Card className="bg-card/80 backdrop-blur-xl border border-border p-5 rounded-xl shadow-xl relative">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          <p className="text-[10px] uppercase tracking-wider text-muted-foreground font-semibold">Predicted Score</p>
          ...
          <Card className="relative overflow-hidden bg-card/60 border border-border border-dashed opacity-80">
            <div className="absolute inset-0 flex items-center justify-center z-10 bg-background/60 backdrop-blur-sm">
              <div className="bg-card px-4 py-2 rounded-full border border-border flex items-center gap-2 shadow-lg">
                ...
                <span className="text-xs font-bold text-foreground uppercase tracking-wider">Unlocks Tomorrow</span>
              </div>
            </div>
            <CardContent className="p-5 sm:p-6 relative">
              ...
              <div className="flex items-center justify-between">
                <div className="flex -space-x-2">
                  <div className="w-7 h-7 rounded-full border-2 border-background bg-muted flex items-center justify-center text-[10px] font-bold text-muted-foreground">---</div>
                </div>
                <button type="button" disabled className="bg-muted border border-transparent px-5 py-2 rounded-xl text-xs font-bold cursor-not-allowed text-muted-foreground">
                  Coming Soon
                </button>
              </div>
            </CardContent>
  ...
  return (
    <Card className="group h-full flex flex-col bg-card border border-border shadow-lg transition-all hover:shadow-xl hover:border-primary/20 hover:-translate-y-0.5">
      <CardContent className="p-5 sm:p-6 flex flex-col flex-1">
        <div className="flex justify-between items-start mb-4">
          <span className={cn('px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-widest', diffBg)}>
            {difficulty}
          </span>
        ...
        <h3 className="text-lg font-bold mb-4 text-foreground group-hover:text-primary transition-colors flex-1 min-h-0">
          ...
          >
            <span className="absolute inset-0 z-0 rounded pointer-events-none" aria-hidden="true" />
        ...
        <div className="flex items-center gap-4 mb-6 text-muted-foreground text-sm">
          ...
          {questions && (
            <>
              <div className="h-8 w-px bg-border" />
              <div className="flex flex-col">
                <span className="text-[10px] uppercase font-bold tracking-wider opacity-70">Questions</span>
