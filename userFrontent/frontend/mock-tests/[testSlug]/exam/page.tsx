...
// Physics schematic: sphere on rough surface with force F at height h (Torque & Rolling Mechanics)
function TorqueDiagram() {
  return (
    ...
    >
      ...
      {/* Force F arrow at height h = 1.6R */}
      <defs>
        <marker
          id="arrowhead"
          markerWidth="10"
      ...
      {/* Height h indicator */}
      <line x1={140} y1={90} x2={200} y2={26} stroke="currentColor" strokeWidth={1} strokeDasharray="2 2" className="text-muted-foreground opacity-60" />
...
export default function MockTestExamPage({
  ...
  const [timer, setTimer] = useState(2 * 60 * 60 + 24 * 60 + 45) // 02:24:45
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <h2 className="text-base font-medium leading-relaxed text-foreground">
                ...
                <span className="font-mono font-semibold">M = 5.0 kg</span> and radius{' '}
                <span className="font-mono font-semibold">R = 0.2 m</span> is placed on a rough
                horizontal surface with a friction coefficient{' '}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start pt-2">
                {/* Diagram - correct physics schematic */}
