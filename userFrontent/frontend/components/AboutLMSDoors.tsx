...
import { MasteryPathSection } from './home/MasteryPathSection'
  ...
  return (
    <div className="bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 font-sans text-slate-100 selection:bg-blue-500/30">
      <style>{`
        ...
        .radial-glow {
          background: radial-gradient(circle at center, rgba(13, 127, 242, 0.15) 0%, transparent 70%);
        }
        .hero-glow {
          background: radial-gradient(circle at 50% 50%, rgba(13, 127, 242, 0.25) 0%, transparent 50%);
        }
        @import url('https://fonts.googleapis.com/css2?family=Lexend:wght@300;400;500;600;700&family=Playfair+Display:ital,wght@0,600;1,600&display=swap');
      ...
      <header className="relative min-h-screen flex items-center justify-center overflow-hidden technical-grid">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-20">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Where artificial intelligence meets elite pedagogy to create an unbreakable foundation for entrance exam mastery.
          </p>
          
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <button className="w-full md:w-auto px-8 py-4 bg-blue-500 text-white font-semibold rounded-lg hover:scale-105 transition-transform shadow-lg shadow-blue-500/20">
              Explore Our Mission
            </button>
            <button className="w-full md:w-auto px-8 py-4 glass-card font-semibold rounded-lg hover:bg-white/5 transition-colors">
              Watch Film
            </button>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="space-y-6 text-slate-400 leading-relaxed">
                <p>LMS Doors began in a small research lab with a single question: Why do high-potential students struggle with standardized testing? We discovered it wasn&apos;t a lack of talent, but a lack of personalized pathway.</p>
                <p>Our founders, a group of IITians and AI researchers, developed the &quot;LMS Protocol&quot;—a series of algorithmic shifts that transform how information is encoded and recalled.</p>
                <p>Today, we serve over 50,000 students globally, providing them not just with content, but with the cognitive keys to unlock their own potential.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            {/* Pillar 1 */}
            <div className="glass-card p-10 rounded-xl hover:translate-y-[-8px] transition-all duration-300">
              ...
              <h4 className="text-xl font-bold mb-4">AI-Powered Precision</h4>
              <p className="text-slate-400 text-sm leading-relaxed">Our neural engines track over 200 data points per session, crafting a learning path that evolves as you do.</p>
            </div>

            {/* Pillar 2 */}
            <div className="glass-card p-10 rounded-xl hover:translate-y-[-8px] transition-all duration-300 border-blue-500/40 relative">
              <div className="absolute -top-3 right-8 bg-blue-500 text-white text-[10px] px-3 py-1 rounded-full uppercase font-bold tracking-widest">Core Pillar</div>
              <div className="w-14 h-14 bg-blue-500/10 rounded-lg flex items-center justify-center mb-8 border border-blue-500/20">
                <svg className="w-8 h-8 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">Content curated by top-tier educators with decades of experience in competitive entrance exam patterns.</p>
            </div>
            ...
            <div className="glass-card p-10 rounded-xl hover:translate-y-[-8px] transition-all duration-300">
              ...
              <h4 className="text-xl font-bold mb-4">Student-Centric Innovation</h4>
              <p className="text-slate-400 text-sm leading-relaxed">Designed for the modern student—intuitive interfaces, gamified progress, and 24/7 mentor support.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-serif mb-4">The Minds Behind LMS Doors</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="group">
              ...
              <h5 className="text-lg font-bold">Dr. Arjan Singh</h5>
              <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-2">Chief Executive Officer</p>
            ...
            <div className="group">
              ...
              <h5 className="text-lg font-bold">Sarah Chen</h5>
              <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-2">Head of AI Research</p>
            ...
            <div className="group">
              ...
              <h5 className="text-lg font-bold">Marcus Voe</h5>
              <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-2">Chief Pedagogy Officer</p>
            ...
            <div className="group">
              ...
              <h5 className="text-lg font-bold">Elena Rodriguez</h5>
              <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-2">Director of Growth</p>
