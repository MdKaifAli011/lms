...
export function Header() {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-3 sm:px-4">
          <div className="flex items-center justify-between h-12 sm:h-14">
                ...
                return (
                  <Link
                    ...
                    className={`text-sm font-semibold capitalize relative pb-1 transition-colors
                      ...
                      ${isActive ? 'after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-blue-600 dark:after:bg-blue-500' : ''}
                    `}
                  >
                    {item.label}
                  </Link>
            ...
            <div className="hidden lg:flex items-center gap-2">
              ...
              <Link href="/register">
                <Button size="sm" className="h-8 px-3 bg-blue-600 hover:bg-blue-700 text-white dark:bg-blue-500 dark:hover:bg-blue-600">
                  Sign up
                </Button>
              </Link>
            </div>
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="lg:hidden fixed top-12 sm:top-14 inset-x-0 z-40
          bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
              ...
              return (
                <Link
                  ...
                  className={`block text-sm font-medium capitalize transition-colors
                    ${isActive
                      ? 'text-blue-600 dark:text-blue-500 bg-blue-50 dark:bg-blue-900/10 px-3 py-2 rounded-lg'
                      : 'text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-500 px-3 py-2'
                    }
                  `}
                >
                  {item.label}
