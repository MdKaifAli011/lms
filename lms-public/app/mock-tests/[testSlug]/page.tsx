        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="bg-card/20 backdrop-blur-md border border-border px-5 py-3 rounded-2xl flex flex-col items-center">
              <span className="text-[9px] uppercase tracking-wider text-muted-foreground font-bold mb-0.5">
                Time Limit
              </span>
      ...
      <div className="mt-6 mb-12">
        <div className="bg-card/40 backdrop-blur-md border border-border rounded-2xl p-5 md:p-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
            <Link
              href="/mock-tests"
              className="px-5 py-2.5 text-center text-xs font-bold text-muted-foreground hover:text-primary transition-all uppercase tracking-wider"
            >
              Exit Test
            </Link>
            {agreed ? (
...
function StatsCard({
  ...
  return (
    <div
      className={cn(
        "bg-card border border-border p-3 rounded-xl backdrop-blur-sm",
        borderClass
      )}
    >
...
function SyllabusCard({
  ...
  return (
    <div
      className={cn(
        "bg-card p-3 rounded-xl border border-border group transition-all",
        colors.hover
      )}
    >
