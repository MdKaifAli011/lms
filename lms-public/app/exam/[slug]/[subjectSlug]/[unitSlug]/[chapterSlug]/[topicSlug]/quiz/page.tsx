...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return { title: `Quiz – ${topicName} | LmsDoors` };
}
...
export default async function TopicQuizPage({ params }: PageProps) {
  ...
  const breadcrumbs = [
    ...
    { label: "Quiz", href: `/exam/${examSlug}/${subjectSlug}/${unitSlug}/${chapterSlug}/${topicSlug}/quiz` },
  ];

  const prevHref = `/exam/${examSlug}/${subjectSlug}/${unitSlug}/${chapterSlug}/quiz`;
  const nextHref = firstSubtopic
    ? `/exam/${examSlug}/${subjectSlug}/${unitSlug}/${chapterSlug}/${topicSlug}/${firstSubtopic.slug ?? firstSubtopic.id}/quiz`
    : null;
