...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return { title: `Flashcards – ${subtopicName} | LmsDoors` };
}

export default async function SubtopicFlashcardsPage({ params }: PageProps) {
  ...
  const breadcrumbs = [
    ...
    { label: "Flashcards", href: `/exam/${examSlug}/${subjectSlug}/${unitSlug}/${chapterSlug}/${topicSlug}/${subtopicSlug}/flashcards` },
  ];

  const prevHref = `/exam/${examSlug}/${subjectSlug}/${unitSlug}/${chapterSlug}/${topicSlug}/flashcards`;
  const nextHref = firstDefinition
    ? `/exam/${examSlug}/${subjectSlug}/${unitSlug}/${chapterSlug}/${topicSlug}/${subtopicSlug}/${firstDefinition.slug ?? firstDefinition.id}/flashcards`
    : null;
