...
import type {TableNode as TableNodeType} from '@lexical/table';
/* Stubs for APIs not in @lexical/table 0.40.0 (exist in newer Lexical) */
function $isSimpleTable(_tableNode: unknown): boolean {
  return true;
}
function $moveTableColumn(
  _tableNode: TableNodeType,
  _startIndex: number,
  _finishIndex: number,
): void {
  /* Column reorder not available in this package version */
}
import {
  $getChildCaret,
