...
import ExamContentSyncPlugin from './plugins/ExamContentSyncPlugin';
...
export default function Editor(): JSX.Element {
  ...
  const [isEmbedded, setIsEmbedded] = useState(
    () => CAN_USE_DOM && document.querySelector('.lexical-playground-embed') != null
  );
  const [editor] = useLexicalComposerContext();

  useEffect(() => {
    setIsEmbedded(CAN_USE_DOM && document.querySelector('.lexical-playground-embed') != null);
  }, []);
  ...
  return (
    <>
      ...
      <div
        ...
        {isEmbedded && <ExamContentSyncPlugin />}
      </div>
